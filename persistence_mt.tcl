...
proc ::turtles::persistence::mt::sched_finalize {recorder stages intervalMillis} {
	if { [thread::exists $recorder] } {
		thread::send -async $recorder [subst { ::turtles::persistence::base::finalize $stages }]
	}
	after $intervalMillis [list ::turtles::persistence::mt::sched_finalize $recorder $stages $intervalMillis]
}
