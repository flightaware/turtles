...
proc ::turtles::persistence::mt::start {{commitMode staged} {intervalMillis 30000} {dbPath ./} {dbPrefix {turtles}}} {
	...
	switch $commitMode {
		staged {
			...
			set ::turtles::persistence::mt::scheduler [thread::create -joinable [subst {
				package require Tcl 8.5 8.6
				package require Thread
				package require turtles::persistence::mt
...
proc ::turtles::persistence::mt::stop {} {
	...
	if { [info exists ::turtles::persistence::mt::scheduler] && [thread::exists $::turtles::persistence::mt::scheduler] } {
		...
		thread::release $::turtles::persistence::mt::scheduler
	}
...
proc ::turtles::persistence::mt::schedule_finalize {nextRef recorderThread stages intervalMillis} {
	if { [thread::exists $recorderThread] } {
		...
		thread::send $recorderThread [subst {
			...
			eval \[ ::turtles::persistence::base::add_call $stages 0 [::turtles::hashing::hash_string ::turtles::persistence::base::finalize] \$time0 \$time0 \[clock microseconds\] \]
		}]
